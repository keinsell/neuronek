...
export { RouteOfAdministrationTable } from './route-of-administration/route-of-administration-table/route-of-administration-table.js'
export { PsychoactiveClassification } from './psychoactive-class/psychoactive-class.js'
export { DosageClassification } from './dosage/dosage-classification.js'
export { PhaseClassification } from './phase/phase-table/phase-classification.js'
