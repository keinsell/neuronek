import { Dataset } from '../../../common/dataset/dataset.js'
...
export class PsychoactiveClass extends Entity<PsychoactiveClassProperties> {
	constructor(properties: PsychoactiveClassProperties) {
		super(properties)
	}
}

const _PsychoactiveClassificationData: { [key in PsychoactiveClassification]: PsychoactiveClass } = {
...
class _PsychoactiveClassDataset extends Dataset<PsychoactiveClass> {
	constructor(
		public data: { [key in PsychoactiveClassification]: PsychoactiveClass } = _PsychoactiveClassificationData
	) {
		super(Object.values(data))
	}

	get(key: PsychoactiveClassification) {
		return this.data[key]
	}
}

export const PsychoactiveClassDataset = new _PsychoactiveClassDataset()
