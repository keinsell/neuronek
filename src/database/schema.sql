...
CREATE TABLE `formulation_ingredient` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `formulation_name` text NOT NULL, `substance_name` text NOT NULL, `dosage` real NOT NULL, CONSTRAINT `0` FOREIGN KEY (`formulation_name`) REFERENCES `formulation` (`name`) ON UPDATE CASCADE ON DELETE CASCADE);
