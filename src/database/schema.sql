...
CREATE TABLE `ingestion` (`id` integer NOT NULL PRIMARY KEY AUTOINCREMENT, `substance_name` varchar NOT NULL, `route_of_administration` varchar NOT NULL, `dosage` float NOT NULL, `dosage_classification` text NULL, `ingested_at` datetime_text NOT NULL, `updated_at` datetime_text NOT NULL, `created_at` datetime_text NOT NULL, CHECK (`dosage_classification` IS NULL OR `dosage_classification` IN
