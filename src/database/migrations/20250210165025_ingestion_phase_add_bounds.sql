...
(
    ...
    `end_date_min`         text    NOT NULL,
    `end_date_max`         text    NOT NULL,
...
INSERT INTO `new_ingestion_phase` (`id`, `ingestion_id`, `classification`, `notes`, `created_at`, `updated_at`)
SELECT `id`, `ingestion_id`, `classification`, `notes`, `created_at`, `updated_at`
