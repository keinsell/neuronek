...
export async function syncPersonalJournal() {
	...
	const ingestions: IngestSubstanceDTO[] = [
		{
			...
			dosage: 10,
			purity: 0.89,
			date: chrono.parseDate("24 September 2022 2:12"),
			set: "",
			setting: "Home",
		},
		{
	...
	const massIngestions: MassIngestSubstanceDTO[] = [
		// Puff Counter: 8752
		{
			...
			purity: 1,
			// Actual time
			endingDate: chrono.parseDate("24 September 2022 02:13"),
			// Time of last tank refill
			startingDate: chrono.parseDate("20 September 2022 11:08"),
			dosages: 8752 - 7123,
		},
		// Puff Counter: 7123
		{
	...
	const firstLine = fs.readFileSync("journal.txt", "utf8").split("\n")[0];
