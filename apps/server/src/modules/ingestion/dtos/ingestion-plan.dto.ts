...
// TODO: Most likely I would like to keep responses in OpenAPI specification, thus we need to find a good solution how to make OAS3 responses as a Class-based DTO.
